...
class StockMovementResource extends Resource
{
    ...
    {
        // 'transfer' rows are auto-generated to mirror another movement (see
        // StockMovementService::maybeCreatePoolTransfer()) — edit the
        // triggering movement instead, which keeps this one in sync.
        if ($record instanceof StockMovement && $record->type === 'transfer') {
            return false;
        }
    ...
    {
        // Deleted automatically alongside the movement that triggered it —
        // see StockMovement::deleteAutoGeneratedTransfers().
        if ($record instanceof StockMovement && $record->type === 'transfer') {
            return false;
        }
