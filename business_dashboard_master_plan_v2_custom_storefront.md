...
[ ] Per-product landed cost allocation (Phase 2 Future Work, Phase 5 profit
    ...
    মাত্র, China-to-BD costs প্রোডাক্ট-লেভেলে allocate হয় না) — এখনো বাকি,
    PROJECT_GUIDE.md-এ এই ফিচারের উল্লেখ নেই
...
[ ] PDF export — invoice ও purchase report — এখনো PROJECT_GUIDE.md-এ
    কোনো উল্লেখ নেই, তাই এখনো বাকি ধরে নেওয়া হচ্ছে
[✅] Backup safety নিয়ম সম্পন্ন (যদিও পূর্ণ automated backup package নয়) —
    ...
    reject করে (দেখুন Part 1.9)। কিন্তু spatie/laravel-backup-এর মতো
    routine scheduled backup package এখনো নিশ্চিত না — verify বাকি।
