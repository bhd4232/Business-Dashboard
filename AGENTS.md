...
- Bangla + English: every new or changed user-visible string must be added to both `lang/en.json` and `lang/bn.json` via `__()` in the same change. Follow `docs/i18n-bangla-english-plan.md`.
